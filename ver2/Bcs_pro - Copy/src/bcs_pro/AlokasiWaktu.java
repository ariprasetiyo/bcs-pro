...
public class AlokasiWaktu extends javax.swing.JInternalFrame {
    ...
    private void PerhitunganTimeDuration(){
        ...
        */
        ...
        drawingPanel.BelanjaStart     = JTextAlokasiInputWaktu.getText();
        drawingPanel.PProduksiStart   = DataStrBelanjaFinish;
        drawingPanel.ProduksiStart    = DataStrPProduksiFinish;
        drawingPanel.PackingStart     = DataStrProdukFinish;
        drawingPanel.DileveryStart    = DataStrPackingFinish;

        drawingPanel.BelanjaFinish    = DataStrBelanjaFinish;
        drawingPanel.PProduksiFinish  = DataStrPProduksiFinish;
        drawingPanel.ProduksiFinish   = DataStrProdukFinish;
        drawingPanel.PackingFinish    = DataStrPackingFinish;
        drawingPanel.DileveryFinish   = DataStrDileveryFinish;

        drawingPanel.BelanjaDuration  = JTextBelanja.getText() + " " +JComboBoxBelanja.getSelectedItem();
        drawingPanel.PProduksiDuration= JTextPraProduksi.getText() + " " +JComboBoxPraProduksi.getSelectedItem();
        drawingPanel.ProduksiDuration = JTextProduksi.getText() + " " +JComboBoxProduksi.getSelectedItem();
        drawingPanel.PackingDuration  = JTextPacking.getText() + " " +JComboBoxPacking.getSelectedItem();
        drawingPanel.DilveryDuration  = JTextDilevery.getText()+ " " +JComboBoxDilevery.getSelectedItem();
    ...
    private void SelekseiMenitJamDanHari2(final JComboBox CB, final JTextField TF){
        if (CB.getSelectedItem().equals("Jam")) {
                if (LimitCharInput (TF.getText(),5)  && Double.valueOf(TF.getText()).doubleValue() <= 24
                        ){
                    JComboBoxAgarTahuComponent(CB, TF);
                     ...
                     TF.setText("0");
                      ...
                      if (LimitCharInput (TF.getText(),2) && Double.valueOf(TF.getText()).doubleValue() <= 60
                        ){
                         JComboBoxAgarTahuComponent(CB, TF);
                      }
                       else{
...
class ButtonJTableKeDuaAlokasiWaktu extends DefaultCellEditor {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(JLabelAlokasiWaktuKeterangan, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
