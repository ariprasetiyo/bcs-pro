...
public class app_search_data_rencana_inventaris_alat_master {
        

	private static List<String> list;
        public app_search_data_rencana_inventaris_alat_master () {
	...
	public static List<String> getData(){
       ...
       try {
           ...
           " SELECT header_penerimaan.judul_resep, header_resep.porsi_resep, header_resep.nama_resep " +
                                            ...
                                            "LIMIT 0 ,20" */
           hasilquery = stm.executeQuery("select NamaAlat  from master_inventaris_alat order by NamaAlat desc");
                                                   }
       ...
       try {
           while(hasilquery.next()){
              ...
              Data_List_Item_Name = hasilquery.getString("namaalat");
