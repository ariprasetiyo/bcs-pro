 ...
 * @author LANTAI3
 */
public class PembelianBahanPenerimanPrint extends JPanel {
  private int fontSize = 90;
  private int messageWidth;
  private String NamaPerusahaan = "PT BCS_PRO";
  private String CreateDate ;
  private String Judul      ="Penerimaan";
   ...
   * Ukuran Kertas
   */
  public PembelianBahanPenerimanPrint(String TransNo, String Date) {
    ...
    int c = 85;
        ...
        ResultSet HQ = null;
           try {
               ...
               HQ = stm.executeQuery("SELECT  trans_no ,qty,nama_bahan, satuan, harga_satuan, harga_tot from detail_trans_penerimaan where trans_no = '"+ TransNo + "' order by no asc  ");                     
