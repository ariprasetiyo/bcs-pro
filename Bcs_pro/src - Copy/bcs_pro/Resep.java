...
public class Resep extends javax.swing.JInternalFrame {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    JTextFieldResepQty.setText(
                            ...
                            SatuanSelect.ConvertSatuan(JComboBoxResepSatuan, JTextFieldResepQty,DatahashMap)));              
                     ConvertKeSatuPorsi();                    
                }
                catch(Exception X){   
                }            
    ...
    private void ConvertKeSatuPorsi(){
       try{
            ...
            JTextFieldResepQty1Porsi.setText(ConvertAngka.NilaiRupiah(HasilConvert + ""));
       }
       catch(Exception x){
   ...
   private void AmbilDataDatabaseSetelahGetBrowse(String PilihData){
    ...
    private void initComponents() {
        ...
        try {
            JTextFieldResepQtyTidakBaku =(javax.swing.JTextField)java.beans.Beans.instantiate(getClass().getClassLoader(), "bcs_pro.Resep_JTextFieldResepQty1");
        ...
        try {
            JComboBoxResepSatuanTidakBaku =(javax.swing.JComboBox)java.beans.Beans.instantiate(getClass().getClassLoader(), "bcs_pro.Resep_JComboBoxResepSatuan1");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (java.io.IOException e) {
            e.printStackTrace();
        ...
        JComboBoxResepSatuan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kg ( Kilogram )", "g ( Gram )", "Sdm ( Sendok Makan )", "Sdt ( Sendok Teh)", "L ( Litter )", "Ml ( Mili Liter )", "Bungkus", "Biji", "Buah", "Ruas", "Kemasan", "Ikat", "Batang", "Lembar" }));
        ...
        JComboBoxResepSatuan1Porsi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kg ( Kilogram )", "g ( Gram )", "Sdm ( Sendok Makan )", "Sdt ( Sendok Teh)", "L ( Litter )", "Ml ( Mili Liter )", "Bungkus", "Biji", "Buah", "Ruas", "Kemasan", "Ikat", "Batang", "Lembar" }));
