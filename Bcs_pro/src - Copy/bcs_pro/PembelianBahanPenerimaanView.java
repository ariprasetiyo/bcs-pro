     ...
     private void AmbilDataDariDatabase(){
        ...
        ResultSet HQ = null;
           try {
               ...
               HQ = stm.executeQuery("SELECT trans_no, judul_resep,supplier, no_po, tanggal_po, note,total_biaya, total_rill , uang_muka, uang_kembali, created_date from header_penerimaan order by created_date desc  ");              
               baris = HQ.getRow();
...
jPanel3Layout.setHorizontalGroup(
    ...
    setBounds((screenSize.width-907)/2, (screenSize.height-398)/2, 907, 398);
