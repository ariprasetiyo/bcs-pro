    ...
    private void AmbilDataDariDatabase(){
        ...
        ResultSet HQ = null;
           try {
               ...
               HQ = stm.executeQuery("SELECT trans_no, nama_resep,supplier, total_biaya, porsi, status_pesanan,uang_muka, created_date from header_pembelian order by created_date desc  ");              
               baris = HQ.getRow();
...
jPanel3Layout.setHorizontalGroup(
    ...
    setBounds((screenSize.width-736)/2, (screenSize.height-398)/2, 736, 398);
