...
INSERT INTO `header_penjualan` (`trans_no`, `nama`, `alamat`, `no_hp`, `note`, `tanggal_dikirim`, `jenis_pesanan`, `jumlah_dipesan`, `dp_status`, `dp_amount`, `bayar`, `total_dibayar`, `updated`, `tanggal_transaksi`, `period`, `status_lunas`) VALUES
('PS2014061', 'ari', 'polaman', '02189641773', 'note', '02-06-2014', 'LUNCH BOX', 111, 0, 0, 10000, 10000, '2014-06-13', '13-06-2014', '201406', 1);
