...
public class app_search_data_rencana_inventaris_alat {
        

	private static List<String> list;
        public app_search_data_rencana_inventaris_alat () {
	...
	public static List<String> getData(){
       ...
       try {
           ...
           " SELECT header_penerimaan.judul_resep, header_resep.porsi_resep, header_resep.nama_resep " +
                                            ...
                                            "LIMIT 0 ,20" */
           hasilquery = stm.executeQuery("select trans_no , nama_pemesan  from header_pesanan order by nama_pemesan desc");
                                                   }
       ...
       String Data_List_Item_Name,Data_List_Item_Name2;
       try {
           while(hasilquery.next()){
              //Data_List_Item_Part = hasilquery.getString("chart_no");
              //Vector_Id.addElement(No_Id);
              Data_List_Item_Name = hasilquery.getString("trans_no");
              Data_List_Item_Name2 = hasilquery.getString("nama_pemesan");
               //System.out.println(coba);
              list.add(Data_List_Item_Name+ " -- " +Data_List_Item_Name2);
           }
