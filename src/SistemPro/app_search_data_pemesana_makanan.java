...
public class app_search_data_pemesana_makanan {
        

	private static List<String> list;
        public app_search_data_pemesana_makanan () {
	...
	public static List<String> getData(){
       ...
       try {
           ...
           " SELECT header_penerimaan.judul_resep, header_resep.porsi_resep, header_resep.nama_resep " +
                                            ...
                                            "LIMIT 0 ,20" */
           hasilquery = stm.executeQuery("select nama_resep  from header_resep order by nama_resep desc");
                                                   }
       ...
       try {
           while(hasilquery.next()){
              ...
              Data_List_Item_Name = hasilquery.getString("nama_resep");
