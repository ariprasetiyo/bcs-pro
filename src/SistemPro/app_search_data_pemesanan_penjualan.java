...
public class app_search_data_pemesanan_penjualan {
        

	private static List<String> list;
        public app_search_data_pemesanan_penjualan () {
	...
	public static List<String> getData(){
       ...
       String Data_List_Item_Name, Data_List_Item_Code;
       try {
           while(hasilquery.next()){
              //Data_List_Item_Part = hasilquery.getString("chart_no");
              //Vector_Id.addElement(No_Id);
              Data_List_Item_Code = hasilquery.getString("trans_no");
              Data_List_Item_Name = hasilquery.getString("nama_pemesan");
               //System.out.println(coba);
              list.add( Data_List_Item_Code + " -- "+ Data_List_Item_Name );
           }
