...
public class app_search_data_beban {
        

	private static List<String> list;
        public app_search_data_beban () {
	...
	public static List<String> getData(){
       ...
       try {
           ...
           " SELECT header_penerimaan.judul_resep, header_resep.porsi_resep, header_resep.nama_resep " +
                                            ...
                                            "LIMIT 0 ,20" */
           hasilquery = stm.executeQuery("select judul_resep,trans_no  from header_penerimaan order by judul_resep desc");
                                                   }
       ...
       try {
           while(hasilquery.next()){
              ...
              Data_List_Item_Name = hasilquery.getString("judul_resep");
              Data_List_Trans_NO = hasilquery.getString("trans_no");
