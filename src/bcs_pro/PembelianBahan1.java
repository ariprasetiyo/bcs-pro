 ...
 * @author LANTAI3
 */
public class PembelianBahan1 extends javax.swing.JInternalFrame {
...
sum(qty_1_porsi )  coba,  qty_1_porsi, satuan_1_porsi  from detail_resep where namresep in ('ayam goreng', 'tempe 2', 'Hanif Resep 1')  group by bahan
                   ...
                   HQ = stm.executeQuery("SELECT DISTINCT  a.bahan, a.namresep"
                           + " ,sum( a.qty_1_porsi ) total_qty, a.satuan, b.porsi_resep, a.satuan_1_porsi "
                           + " from detail_resep a inner join  header_resep b on a.namresep = b.nama_resep "
                           + " where namresep in ( "+ PilihData + " )"
                           + " GROUP BY bahan");
         ...
         if (ValidasiSebelumDiSave() == true){
            ...
            try {
                 ...
                 try {
                    ...
                    Logger.getLogger(PembelianBahan1.class.getName()).log(Level.SEVERE, null, Ex);
                 }              
             } 
         else{
