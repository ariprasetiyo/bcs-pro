                     ...
                     if (Pilih == JOptionPane.YES_OPTION){
                         ...
                         if (Edit2){
                            ...
                            ModelTabel2.removeRow(row ); 
                             ...
                             JOptionPane.showMessageDialog(null, "Tidak bisa dihapus karena status data search\n"
                                      + "Mohon kongankabn text yang ada di search", "Info", JOptionPane.INFORMATION_MESSAGE);
                         }
