...
public class PembelianBahanPenerimaanView extends javax.swing.JDialog {
    ...
    public PembelianBahanPenerimaanView(java.awt.Frame parent, boolean modal) {
     ...
     private void TabelDataViewPenerimaan(){
         ...
         String header[] = {"No", "Trans No Wr","Trans No Po","Nama Resep","Supplier","Total Biaya", "Total Rill","Uang Muka","Uang Kembali","Tanggal Wr", "Tanggal Po","Note" };
       ...
       JTabelViewPenerimaan.setRowSorter(sorter);
        ...
        JTabelViewPenerimaan.getColumnModel().getColumn(8).setCellRenderer( kanan );
        JTabelViewPenerimaan.getColumnModel().getColumn(9).setCellRenderer( tengah );
        JTabelViewPenerimaan.getColumnModel().getColumn(10).setCellRenderer( tengah );
         ...
         */      
        int jarak_colom[] = {40,80,80,300, 300,100,100,100, 100,100,100,100};
    ...
    private String AmbilDataPeriodDhooser(){
     ...
     private void AmbilDataDariDatabase(String Period){
         ...
         */      
        System.out.println(AmbilDataPeriodDhooser());
        int baris;       
        ResultSet HQ = null;
           try {
               Statement stm = K.createStatement();
               HQ = stm.executeQuery("SELECT trans_no, judul_resep,supplier, no_po, tanggal_po, note,total_biaya, total_rill , uang_muka, uang_kembali, created_date from header_penerimaan "
               ...
               while(HQ.next()  ){
                   ...
                   String PenerimaanUangKem     = HQ.getString("uang_Kembali"); 
                   String PenerimaanTotRill     = HQ.getString("total_rill");
                   
                   String[] add         = {String.valueOf(HQ.getRow()).toString() , PembelianTransNo , PenerimaanNoPo,
                       PembelainNamaResep,PembelianSupplier,
                       PembelianTotBiaya,PenerimaanTotRill, PembelianUangMuka ,PenerimaanUangKem,
    ...
    private void DiKirimKePembelian(){
         ...
         for(int i=0; i<numRows ; i++ ) {
            ...
            String AmbilUangMuka        = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 7);
            String AmbilTotBiaya        = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 5);
            String AmbilTotRill         = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 6);
            String AmbilKembali         = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 8);
            String AmbilTanggalWr       = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 9);
            String AmbilTanggalPo       = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 10);
            String AmbilTransNoPo       = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 2);
            String AmbilNote            = (String) TabelModelViewPenerimaan.getValueAt(AmbilRow, 11);
            ...
            DataObject.SetPenerimaanTotalRill(AmbilTotRill);
    ...
    setBounds((screenSize.width-907)/2, (screenSize.height-374)/2, 907, 374);
